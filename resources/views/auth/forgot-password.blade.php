            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form class="mb-4" :status="session('status')" method="POST" action="{{ route('password.email') }}">
                                @csrf
                                ...
                                <div class="form-group pb-2 text-center row mt-3">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit"     {{ __('Email Password Reset Link') }}>Send Email</button>
                                    </div>
                                </div>
                            </form>
                        </div>
