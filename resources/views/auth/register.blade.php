...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Green" name="author" />
        <!-- App favicon --> 
    ...
    <body class="auth-body-bg">
        ...
        <div class="form-group mb-3 row">
            <div class="col-12">
                <input class="form-control" id="password_confirmation" type="password" required="" name="password_confirmation" placeholder="Password_Confirmation">
            </div>
        </div>
